    ...
    def generate_authoritative_report(self, response: ScreenResponse) -> str:
        ...
        for r in response.results:
            ...
            lines.extend([
                ...
                f"- **Four-Tier Quantitative Breakdown**:",
                f"  - *Tier 1 (Vendor Measured Data)*: CMP: **{price_str}** (**{chg_str}**) | Market Capitalization: **{r.market_cap_str}** [Vendor Source-Reported: TwelveData / Yahoo Finance Feed]",
                f"  - *Tier 2 (Calculated Technical & Valuation)*: Valuation Multiple Score: **{r.valuation_score.score:.2f}/10** | Momentum Trend Score: **{r.momentum_score.score:.2f}/10** | Technical Score: **{r.technical_score.score:.2f}/10** | Risk Management Score: **{r.risk_score.score:.2f}/10** | Market Regime Alignment: **{r.regime_score.score:.2f}/10** [Deterministic In-Memory Model; Q3 FY25 TTM Filings]",
                f"  - *Tier 3 (Heuristic & Synthetic Proxies - Non-Predictive)*: Delivery Flow Anomaly Proxy: **{r.institutional_score.score:.2f}/10** | SMC Market Structure Proxy: **{smc_val}** | 30d Volatility Envelope: **{fc_val}*** | Retrospective Factor Alignment: **{bt_val}***",
                f"  - *Tier 4 (Data Gaps & Missing Confirmations)*: F&O Derivatives Sentiment: **{fno_val}** | Depository Custodial Ownership Filings: **UNAVAILABLE in Real-Time Feed**",
